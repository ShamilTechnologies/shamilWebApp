...
exports.validateAccess = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const userName = (userData === null || userData === void 0 ? void 0 : userData.displayName) || (userData === null || userData === void 0 ? void 0 : userData.name) || 'Unknown User';
        ...
        const pricingModel = (providerData === null || providerData === void 0 ? void 0 : providerData.pricingModel) || 'other';
                ...
                if (reservation.dateTime) {
                    ...
                    if (resDate.getTime() === today.getTime()) {
                        ...
                        if (!endTime && reservation.duration) {
                            ...
                            endTime = new admin.firestore.Timestamp(startTime.getTime() / 1000 + (reservation.duration * 60), 0);
                        }
                        else if (!endTime) {
                            // Default to 1 hour duration
                            const startTime = reservation.dateTime.toDate();
                            endTime = new admin.firestore.Timestamp(startTime.getTime() / 1000 + (60 * 60), 0);
                        }
                        reservationData = {
                            id: doc.id,
        ...
        switch (pricingModel) {
            ...
            case 'hybrid':
                ...
                message = hasAccess ? `Access granted via ${(accessType === null || accessType === void 0 ? void 0 : accessType.toLowerCase()) || 'unknown'}` : 'No active subscription or reservation';
                break;
            case 'other':
